...
/*      // commented out for local dev with internet access
        // uncomment when done? Dunno, maybe want to always direct to local files
        // if this will be a local-only branch or something        
        chilipeppr_ready: ['http://www.chilipeppr.com/js/main', 'js/main'],
        chilipeppr_init2: ['http://www.chilipeppr.com/js/app2', 'js/app2'],
        chilipeppr_init: ['http://www.chilipeppr.com/js/app', 'js/app'],
        google: ['http://www.google-analytics.com/analytics', ''],
        jquery: ['http://code.jquery.com/jquery-2.1.0.min', 'js/jquery-2.1.0.min'],
        bootstrap: ['http://netdna.bootstrapcdn.com/bootstrap/3.1.1/js/bootstrap.min', 'js/bootstrap.min'],
        amplify: ['http://www.chilipeppr.com/js/amplify-1.1.2/amplify', 'js/amplify'],
        jquerycookie: ['http://www.chilipeppr.com/js/jquery-cookie/jquery.cookie', 'js/jquery.cookie'],
        jqueryui: ['http://chilipeppr.com/js/jquery-ui-1.10.4/ui/jquery.ui.core', 'js/jquery.ui.core'],
        jqueryuiWidget: ['http://chilipeppr.com/js/jquery-ui-1.10.4/ui/jquery.ui.widget', 'js/jquery.ui.widget'],
        jqueryuiMouse: ['http://chilipeppr.com/js/jquery-ui-1.10.4/ui/jquery.ui.mouse', 'js/jquery.ui.mouse'],
        jqueryuiResizeable: ['http://chilipeppr.com/js/jquery-ui-1.10.4/ui/jquery.ui.resizable', 'js/jquery.ui.resizable'],
*/
